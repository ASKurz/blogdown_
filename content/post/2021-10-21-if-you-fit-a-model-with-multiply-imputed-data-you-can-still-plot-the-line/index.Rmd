...
Edited on October 9, 2022. Doctoral candidate Reinier van Linschoten kindly pointed out a mistake in my **R** code for $V_B$, the between imputation variance. The blog post now includes the corrected workflow.
