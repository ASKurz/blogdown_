...
At this point, though, you may be wondering how this model, with all its lognormal $\lambda_i$ glory, can inform us about actual counts. You know, the kind of counts that allowed us to fut such a wacky model. We'll want to work with the posterior draws for that, too. First we extract all of the posterior draws for the population parameters.
