...
Because of it's nice interpretative properties, I (and many others) like to use the cumulative standard normal distribution $\Phi$ as our function $f(\cdot)$, which means we can rewrite the equation as
...
\color{blue}{\mu_i} & \color{blue}= \color{blue}{\beta_0 + \sum_1^l \beta_l x_l} \\
\color{blue}{\beta_0} & \color{blue}= \color{blue}0,
\end{align*}
$$
...
\color{blue}{\log(\sigma_i)} & \color{blue}= \color{blue}{\eta_0 + \sum_1^m \eta_m x_m} \\
\beta_0 & = 0 \\
\color{blue}{\eta_0} & \color{blue}= \color{blue}0,
\end{align*}
$$
...
\mu_i & = \beta_0 + \sum_1^l \beta_l x_l \\
\log(\color{blue}{\alpha_i}) & = \eta_0 + \sum_1^m \eta_m x_m \\
\beta_0 & = 0 \\
\eta_0 & = 0.
\end{align*}
$$
...
\color{blue}{u_i} & \color{blue}\sim \color{blue}{\mathcal N(0, \sigma_u)} \\
\tau_1 & \sim \mathcal N(-0.97, 1) \\
\tau_2 & \sim \mathcal N(-0.43, 1) \\
\tau_3 & \sim \mathcal N(0, 1) \\
\tau_4 & \sim \mathcal N(0.43, 1) \\
\tau_5 & \sim \mathcal N(0.97, 1) \\
\color{blue}{\sigma_u} & \color{blue}\sim \color{blue}{\operatorname{Exponential}(1)},
\end{align*}
$$
...
\mu_{i\color{blue}j} & = 0 + u_i \color{blue}{+ v_j} \\ 
u_i               & \sim \mathcal N(0, \sigma_u) \\
\color{blue}{v_j} & \color{blue}\sim \color{blue}{\mathcal N(0, \sigma_v)} \\
\tau_1 & \sim \mathcal N(-0.97, 1) \\
\tau_2 & \sim \mathcal N(-0.43, 1) \\
\tau_3 & \sim \mathcal N(0, 1) \\
\tau_4 & \sim \mathcal N(0.43, 1) \\
...
\color{blue}{\sigma_v} & \color{blue}\sim \color{blue}{\operatorname{Exponential}(1)}.
\end{align*}
$$
...
$$
\begin{align*}
p(\text{rating} = k | \{ \tau_{kj} \}, \mu_{ij}, \color{blue}{\alpha_{ij}}) & = \Phi(\color{blue}{\alpha_{ij}}[\tau_{kj} - \mu_{ij}]) - \Phi(\color{blue}{\alpha_{ij}}[\tau_{k - 1,j} - \mu_{ij}]) \\
\mu_{ij} & = 0 + u_i + v_j \\ 
\color{blue}{\log(\alpha_{ij})} & \color{blue}= \color{blue}{0 + w_i + x_j} \\
u_i & \sim \mathcal N(0, \sigma_u) \\
v_j & \sim \mathcal N(0, \sigma_v) \\

\color{blue}{w_i} & \color{blue}\sim \color{blue}{\mathcal N(0, \sigma_w)} \\
\color{blue}{x_j} & \color{blue}\sim \color{blue}{\mathcal N(0, \sigma_x)} \\
...
\sigma_u & \sim \operatorname{Exponential}(1) \\
\sigma_v & \sim \operatorname{Exponential}(1) \\
\color{blue}{\sigma_w} & \color{blue}\sim \color{blue}{\operatorname{Exponential}(1)} \\
\color{blue}{\sigma_x} & \color{blue}\sim \color{blue}{\operatorname{Exponential}(1)}.
\end{align*}
$$
...
$$
\begin{align*}
p(\text{rating} = k | \{ \tau_{kj} \}, \mu_{ij}, \alpha_{ij}) & = \Phi(\alpha_{ij}[\tau_{kj} - \mu_{ij}]) - \Phi(\alpha_{ij}[\tau_{k - 1,j} - \mu_{ij}]) \\
\mu_{ij} & = 0 + u_i + v_j \\ 
...
\color{blue}{\mathbf{R_a}} & \color{blue}= \color{blue}{\begin{bmatrix} 1 & \rho_a \\ \rho_a & 1 \end{bmatrix}} \\
\color{blue}{\mathbf{R_b}} & \color{blue}= \color{blue}{\begin{bmatrix} 1 & \rho_b \\ \rho_b & 1 \end{bmatrix}} \\
...
\color{blue}{\rho_a} & \color{blue}\sim \color{blue}{\operatorname{LKJ}(2)} \\
\color{blue}{\rho_b} & \color{blue}\sim \color{blue}{\operatorname{LKJ}(2)},
\end{align*}
$$
...
\tau_{4j} & \sim \mathcal N(0.43, 1) \\
\tau_{5j} & \sim \mathcal N(0.97, 1) \\
\color{blue}{\beta_1} & \color{blue}\sim \color{blue}{\mathcal N(0, 1)} \\
\color{blue}{\eta_1}  & \color{blue}\sim \color{blue}{\mathcal N(0, 0.347)} \\
\sigma_u & \sim \operatorname{Exponential}(1) \\
\sigma_v & \sim \operatorname{Exponential}(1) \\
\sigma_w & \sim \operatorname{Exponential}(1 / 0.463) \\
\sigma_x & \sim \operatorname{Exponential}(1 / 0.463).
