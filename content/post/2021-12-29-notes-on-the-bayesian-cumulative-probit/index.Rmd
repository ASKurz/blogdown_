...
It might help to visualize this. Consider a case where we have a rating variable with 6 values (`1` through `6`), each with equal proportions 
($1 / 6 \approx .167$). Here's what that could look like mapped onto $\Phi$.
